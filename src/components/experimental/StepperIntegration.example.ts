    ...
    this.pulseSubscription = pulse.currentStepSubject
      ...
      .subscribe({
        next: ({ time }) => {
          ...
          console.log(`[Stepper ${this.id}] Playing ${this.sampleName} at ${time}`);
        },
        complete: () => {
...
function example1_OrderIndependence() {
  ...
  const s1 = { id: 1, beats: 4, stepsPerBeat: 4, steps: 16, sampleName: "kick" } as Stepper;
  const s2 = { id: 2, beats: 1, stepsPerBeat: 4, steps: 4, sampleName: "snare" } as Stepper;
  const s3 = { id: 3, beats: 16, stepsPerBeat: 4, steps: 64, sampleName: "hh" } as Stepper;
  const s4 = { id: 4, beats: 2, stepsPerBeat: 4, steps: 8, sampleName: "clap" } as Stepper;
...
function example2_UpdateWithPromotion() {
  ...
  const s1 = { id: 1, beats: 16, stepsPerBeat: 4, steps: 64, sampleName: "kick" } as Stepper;
  const s2 = { id: 2, beats: 8, stepsPerBeat: 4, steps: 32, sampleName: "snare" } as Stepper;
  const s3 = { id: 3, beats: 4, stepsPerBeat: 4, steps: 16, sampleName: "hh" } as Stepper;
  const s4 = { id: 4, beats: 2, stepsPerBeat: 4, steps: 8, sampleName: "clap" } as Stepper;
...
function example3_UnrelatedPulses() {
  ...
  const s1 = { id: 1, beats: 7, stepsPerBeat: 1, steps: 7, sampleName: "kick" } as Stepper;
  const s2 = { id: 2, beats: 11, stepsPerBeat: 1, steps: 11, sampleName: "snare" } as Stepper;
  const s3 = { id: 3, beats: 13, stepsPerBeat: 1, steps: 13, sampleName: "hh" } as Stepper;
